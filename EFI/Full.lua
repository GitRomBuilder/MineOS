	...
	if eventData[1] == stringKeyDown and eventData[4] == 56 then
		...
		if internetAddress then	
			tableInsert(utilities, 2, menuElement("Internet recovery", function()
				local handle, data, result, reason = componentProxy(internetAddress).request("https://raw.githubusercontent.com/GitRomBuilder/ShadowOS/master/Installer/Main.lua"), ""
